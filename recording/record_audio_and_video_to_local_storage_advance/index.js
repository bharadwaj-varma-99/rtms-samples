    ...
    mediaWs.on('message', (data) => {
        try {
            ...
            if (msg.msg_type === 14 && msg.content && msg.content.data) {
                ...
                saveRawAudio(buffer, meetingUuid, user_id,epochMilliseconds);
            }
            // Handle video data
            if (msg.msg_type === 15 && msg.content && msg.content.data) {
                ...
                saveRawVideo(buffer, user_name, timestamp, meetingUuid,epochMilliseconds);
            }
